...
For languages that support auto importing through their LSP, `telescope-import` can still be of benefit by importing multiple exports in fewer keystrokes.
